...
export async function onRequestGet(context) {
  const { env } = context;
  return json(200, { ok: true, version: "v8.4.1", ...bindingStatus(env), botKeyRequired: !!env.PROTOTYPE_KEY, siteKeyRequired: !!env.SITE_KEY });
}
...
export async function onRequestPost(context) {
  ...
  const system = [
    "You are an assistant helping answer questions about Marin Transit's Personnel Policies and Procedures.",
